from stuff import cards_values
from arts import logo
import random

# print(logo)
# if input("Você quer jogar uma partida de Blackjack? Escreva 's' ou 'n': \n") == 's':
#     cartas_jogador = []
#     cartas_computador = []
#     total = 0
#     def cartas_inicio():
#         """
#         It adds two random cards to the player's hand and two random cards to the computer's hand.
#         """
#         for i in range(2):
#             cartas_jogador.append(random.choice(cards))
#             cartas_computador.append(random.choice(cards))
#     def pegar_cartas():
#         cartas_jogador.append(random.choice(cards))
#     def contar_total():
#         for i in cards_values:
#             if cartas_jogador[n] == "ÀS":
#                 total += 11
#             elif cartas_jogador
#     cartas_inicio()
#     print(f"Suas cartas são: {cartas_jogador}")
#     print(f"Mão do computador: {cartas_computador[1]}")
    
#     if input("Digite 's' caso queira mais uma carta, ou 'n' caso queira passar: \n") == 's':
#         pegar_cartas()
...
def calculate_score(cards):
  """
  If the sum of the cards is 21 and there are only two cards, return 0. If there is an 11 in the cards
  and the sum of the cards is greater than 21, remove the 11 and add a 1. Return the sum of the cards.
...
def compare(user_score, computer_score):
  """
  If the user and computer both go over 21, it's a draw. If the user has a blackjack, they win. If the
  computer has a blackjack, they lose. If the user goes over 21, they lose. If the computer goes over
  21, they win. If the user has a higher score than the computer, they win. Otherwise, they lose
...
def play_game():
  ...
  # It's dealing two cards to the user and two cards to the computer.
  for _ in range(2):
    user_cards.append(deal_card())
    computer_cards.append(deal_card())

    # It's checking if the game is over. If it's not, it's printing the user's cards and the
    ...
    while not is_game_over:
      ...
      if user_score == 0 or computer_score == 0 or user_score > 21:
        ...
        if user_should_deal == "y":
          ...
          is_game_over = True
  # It's checking if the computer has a blackjack (0) or if the computer's score is less than 17. If
  # it's not, it's adding a card to the computer's hand and recalculating the score.
